...
(defvar import-js-d-program "importjsd")
...
;;;###autoload
(defvar import-js-find-definition-stack ())

(defun import-js-pop-goto-definition ()
  (interactive)
...
(defun run-import-js ()
  ...
  (let ((process-connection-type nil))
    (setq import-js-process (start-process "import-js" nil import-js-d-program
                              "start" (format "--parent-pid=%s" (emacs-pid))))
