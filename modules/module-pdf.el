...
(use-package pdf-tools
  ...
  (progn
    ...
    (dotemacs-define-transient-state pdf-tools
 ...
 "
    ...
    (dotemacs-declare-prefix-for-mode 'pdf-view-mode "ma" "annotations")
    (dotemacs-declare-prefix-for-mode 'pdf-view-mode "mf" "fit")
    (dotemacs-declare-prefix-for-mode 'pdf-view-mode "ms" "slice/search")
    (dotemacs-set-leader-keys-for-major-mode 'pdf-view-mode
      "." 'dotemacs/pdf-tools-transient-state/body
      ;; Slicing image
