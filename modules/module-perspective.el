...
(defvar dotemacs--layouts-ts-full-hint-toggle 0
  "Display a short doc when nil, full doc otherwise.")

(defvar dotemacs--workspaces-ts-full-hint-toggle 0
  "Display a short doc when nil, full doc otherwise.")

(defvar dotemacs--last-selected-layout dotemacs-default-layout-name
...
`:body EXPRESSIONS'
  ...
  (let* ((name (if (symbolp name)
         ...
         (binding-prop (car (dotemacs-mplist-get props :binding)))
 ...
 [_?_]^^   toggle help\n")
    ...
    (dotemacs-define-transient-state layouts
      ...
      :dynamic-hint (dotemacs//layouts-ts-hint)
        ...
        ("C-1" dotemacs/persp-switch-to-1)
        ("C-2" dotemacs/persp-switch-to-2)
        ("C-3" dotemacs/persp-switch-to-3)
        ("C-4" dotemacs/persp-switch-to-4)
        ("C-5" dotemacs/persp-switch-to-5)
        ("C-6" dotemacs/persp-switch-to-6)
        ("C-7" dotemacs/persp-switch-to-7)
        ("C-8" dotemacs/persp-switch-to-8)
        ("C-9" dotemacs/persp-switch-to-9)
        ("C-0" dotemacs/persp-switch-to-0)
