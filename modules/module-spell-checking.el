...
(defun grammar-checking/add-writegood-hook (hook)
...
(use-package writegood-mode
  ...
  :init
  (progn
    (grammar-checking/add-writegood-hook 'text-mode-hook)

    (dotemacs-add-toggle writegood-mode
    ...
    (dotemacs-set-leader-keys
      "Gb" 'writegood-grade-level
      "Gd" 'writegood-reading-ease)
...
(use-package langtool
  ...
  (progn
    ...
    (dotemacs-set-leader-keys
      "Gw" 'langtool-check
      "GW" 'langtool-check-done
      "Gp" 'langtool-show-message-at-point
      "Gb" 'langtool-correct-buffer)))
