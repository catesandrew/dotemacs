...
(use-package restart-emacs
  ...
  (defun dotemacs/restart-emacs-debug-init (&optional args)
    "Restart emacs and enable debug-init."
    (interactive)
    (dotemacs/restart-emacs (cons "--debug-init" args)))
  (defun dotemacs/restart-stock-emacs-with-packages (packages &optional args)
    "Restart emacs without the configuration, enable debug-init
and load the given list of packages."
    (interactive
     (progn
